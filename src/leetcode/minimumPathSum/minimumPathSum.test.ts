...
describe('#minimumPathSum', () => {
  describe('when the input array has only 1 element', () => {
    it('returns the elements value', () => {
  ...
  describe('example 2', () => {
    ...
    it('returns as expected', () => {
      expect(minPathSum(input)).toEqual(12);
    });
  });
  ...
  describe('example 3', () => {
    ...
    it('returns as expected', () => {
      expect(minPathSum(input)).toEqual(9);
    });
  });
  ...
  describe('example 4', () => {
    ...
    it('returns as expected', () => {
      expect(minPathSum(input)).toBe(83);
    });
  });
});
